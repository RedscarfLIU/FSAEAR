...
%提取data14的差异帧样本及标签
 ...
 %构建训练所用数据集（样本和标签）
 data_TRAIN = [data21_DF;data22_DF;data23_DF;data24_DF;data31_DF;data32_DF;data33_DF;data34_DF;data41_DF;data42_DF;data43_DF;data44_DF];
 
 %迭代1：data_TRAIN = [data11_DF;data12_DF;data13_DF;data14_DF;data21_DF;data22_DF;data23_DF;data24_DF;data31_DF;data32_DF;data33_DF;data34_DF];
 %迭代2：data_TRAIN = [data11_DF;data12_DF;data13_DF;data14_DF;data21_DF;data22_DF;data23_DF;data24_DF;data41_DF;data42_DF;data43_DF;data44_DF];
 %迭代3：data_TRAIN = [data11_DF;data12_DF;data13_DF;data14_DF;data31_DF;data32_DF;data33_DF;data34_DF;data41_DF;data42_DF;data43_DF;data44_DF];
 %迭代4：data_TRAIN = [data21_DF;data22_DF;data23_DF;data24_DF;data31_DF;data32_DF;data33_DF;data34_DF;data41_DF;data42_DF;data43_DF;data44_DF];
 
 %构建测试所用数据集（样本和标签）
 data_TEST = [data11_DF;data12_DF;data13_DF;data14_DF];
 
 %迭代1：data_TEST = [data41_DF;data42_DF;data43_DF;data44_DF];
 %迭代2：data_TEST = [data31_DF;data32_DF;data33_DF;data34_DF];
 %迭代3：data_TEST = [data21_DF;data22_DF;data23_DF;data24_DF];
 %迭代4：data_TEST = [data11_DF;data12_DF;data13_DF;data14_DF];
 ...
 for i = 1:m
  ...
  %将测试/验证的test_label和final_label写入excel表
 %xlswrite('AB_DF_classification.xlsx', test_label, 'Sheet1', 'A1');
 %xlswrite('AB_DF_classification.xlsx', final_label, 'Sheet1', 'B1');
